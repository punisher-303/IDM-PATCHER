...
::
::   Homepages: https://github.com/punisher-303/IDM-PATCHER
::              BY ANAND PM
::
::       Instagram: @appuz224
::
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Create By The Anand PM"
echo:            ___________________________________________________ 
echo:
echo:               Instagram: @appuz224
echo:               Github: https://github.com/punisher-303
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
...
if %_erl%==8 exit /b
if %_erl%==7 start https://github.com/punisher-303/IDM-PATCHER & goto MainMenu
...
echo %line%
echo:
choice /C:01 /N /M ">    [0] Go Back [1] Activate : "
